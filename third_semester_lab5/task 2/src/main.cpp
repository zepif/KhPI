...
int main() {
    try {
        ...
        std::cout
            << "\nКрок б: Обчислення виразу А з виведенням стану контейнера."
            << std::endl;
        ...
        std::cout << "\nКрок в: Створення арифметичного виразу B з файлу."
                  << std::endl;
        ...
        std::cout
            << "\nКрок г: Обчислення виразу B з виведенням стану контейнера."
            << std::endl;
